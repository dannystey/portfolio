...
<div class="print:hidden" >
    <div class="max-w-screen-xl mx-auto px-5 lg:px-8 relative">
        ...
        <div class="button-animate hidden lg:block text-transparent w-10 h-10 rounded-full absolute z-20 top-5 right-5">
            <a aria-label="Contact" href="mailto:hi@steylish.de" class="bg-neutral-800 z-10 w-full h-full rounded-full absolute top-0 left-0 cursor-pointer hover:bg-neutral-700 text-neutral-100 flex items-center justify-center">
